...
const HomePage: React.FC = () => {
    ...
    return (
        <div className="bg-gray-800 rounded-lg p-8 shadow-xl">
            ...
            <p className="text-gray-300 mb-6">You are now part of a global competition for top tech recruiters. Compete in sourcing games, get feedback from our AI Coach, and climb the leaderboard to prove you're the best.</p>
